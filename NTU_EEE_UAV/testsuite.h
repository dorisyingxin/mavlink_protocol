...
static void mavlink_test_uwb_position_estimate(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_uwb_position_estimate_t packet_in = {
		93372036854775807ULL,73.0,101.0,129.0,157.0,185.0,213.0,241.0,963499336
    };
	...
	mavlink_msg_uwb_position_estimate_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_uwb_position_estimate_pack(system_id, component_id, &msg , packet1.usec , packet1.x , packet1.y , packet1.z , packet1.target_x , packet1.target_y , packet1.target_z , packet1.target_yaw , packet1.flight_mode );
	mavlink_msg_uwb_position_estimate_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_uwb_position_estimate_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.usec , packet1.x , packet1.y , packet1.z , packet1.target_x , packet1.target_y , packet1.target_z , packet1.target_yaw , packet1.flight_mode );
	mavlink_msg_uwb_position_estimate_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_uwb_position_estimate_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_uwb_position_estimate_send(MAVLINK_COMM_1 , packet1.usec , packet1.x , packet1.y , packet1.z , packet1.target_x , packet1.target_y , packet1.target_z , packet1.target_yaw , packet1.flight_mode );
	mavlink_msg_uwb_position_estimate_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_fruitdove(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_fruitdove_t packet_in = {
		93372036854775807ULL,73.0,101.0,129.0,963498504,963498712,963498920,241.0,269.0,297.0,19523,19627,149
    };
	...
	mavlink_msg_fruitdove_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_fruitdove_pack(system_id, component_id, &msg , packet1.usec , packet1.gps_raw_x , packet1.gps_raw_y , packet1.gps_raw_z , packet1.gps_raw_lat_int , packet1.gps_raw_lon_int , packet1.gps_raw_alt_int , packet1.eph , packet1.epv , packet1.local_ned_x , packet1.local_ned_y , packet1.local_ned_z , packet1.satellites_visible );
	mavlink_msg_fruitdove_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_fruitdove_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.usec , packet1.gps_raw_x , packet1.gps_raw_y , packet1.gps_raw_z , packet1.gps_raw_lat_int , packet1.gps_raw_lon_int , packet1.gps_raw_alt_int , packet1.eph , packet1.epv , packet1.local_ned_x , packet1.local_ned_y , packet1.local_ned_z , packet1.satellites_visible );
	mavlink_msg_fruitdove_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_fruitdove_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_fruitdove_send(MAVLINK_COMM_1 , packet1.usec , packet1.gps_raw_x , packet1.gps_raw_y , packet1.gps_raw_z , packet1.gps_raw_lat_int , packet1.gps_raw_lon_int , packet1.gps_raw_alt_int , packet1.eph , packet1.epv , packet1.local_ned_x , packet1.local_ned_y , packet1.local_ned_z , packet1.satellites_visible );
	mavlink_msg_fruitdove_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
